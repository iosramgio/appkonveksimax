              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 sm:p-6">
                    {/* Rejected Order Indicator */}
                    {(order.status === 'Ditolak' || order.verificationStatus === 'Ditolak') && (
                      <div className="mb-3 bg-red-50 border border-red-100 rounded-md p-2 flex items-center">
                        ...
                        <span className="text-xs text-red-700 font-medium">
                          {order.status === 'Ditolak' ? 'Pesanan ini telah ditolak' : 'Pesanan ini tidak diverifikasi'}
                        </span>
                      </div>
                    )}
                      ...
                      <div className="mb-4 sm:mb-0">
                        ...
                        <div className="flex flex-wrap gap-2 mt-3">
                          ...
                          {order.verificationStatus === 'Ditolak' && (
                            <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${getVerificationBadgeClass(order.verificationStatus)}`}>
                              Pesanan Ditolak
                            </span>
                          )}
                        </div>
