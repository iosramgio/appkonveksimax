  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-6 sm:w-6 text-white" viewBox="0 0 24 24" fill="currentColor">
        ...
        <span className="absolute w-full h-full rounded-full border-4 border-[#25D366]/40 animate-[ping_1.5s_cubic-bezier(0,0,0.2,1)_infinite]"></span>
        <span className="absolute w-[115%] h-[115%] rounded-full border-2 border-[#25D366]/30 animate-[ping_2s_cubic-bezier(0,0,0.2,1)_infinite]"></span>
      </a>
    </div>
  );
};
